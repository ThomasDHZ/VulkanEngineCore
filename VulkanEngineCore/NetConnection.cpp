...
{
	uint16 diff = static_cast<uint16>(sequence - m_remoteSequence);
...
bool NetConnection::IsSequenceNewer(uint16 s1, uint16 s2) const
{
	return static_cast<uint16>(s1 - s2) < 0x8000;
}
